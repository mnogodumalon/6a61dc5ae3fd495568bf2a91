// Auto-generated. Per-entity form-enhancements config for "Überzahlungsbearbeitung".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["forderung", "ueberzahlter_betrag", {"row": ["eingangsdatum_zahlung", "bearbeitungsdatum"]}, "massnahme", "bearbeitungsstatus", {"row": ["kontoinhaber_vorname", "kontoinhaber_nachname"]}, "iban", "bic", "bank", "bemerkungen"],
  defaults: {
    "eingangsdatum_zahlung": { kind: "today" },
    "bearbeitungsdatum": { kind: "today" },
    "bearbeitungsstatus": { kind: "lookup", key: "offen", label: "Offen" },
    "ueberzahlter_betrag": { kind: "literal", value: 0 },
  },
  computed: {
    '_restschuld': { op: 'sub', left: { op: 'sub', left: { kind: 'applookup', ownKey: 'forderung', lookupKey: 'rechnungsbetrag' }, right: { kind: 'applookup', ownKey: 'forderung', lookupKey: 'gezahlter_betrag' } }, right: { kind: 'field', key: 'ueberzahlter_betrag' } },
  },
};
