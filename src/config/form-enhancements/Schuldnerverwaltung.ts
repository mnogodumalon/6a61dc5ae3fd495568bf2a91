// Auto-generated. Per-entity form-enhancements config for "Schuldnerverwaltung".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["kundennummer", {"row": ["schuldner_vorname", "schuldner_nachname"]}, "unternehmen", "letzter_vorgang", {"row": ["strasse", "hausnummer"], "cols": "2fr 1fr"}, {"row": ["postleitzahl", "ort"], "cols": "1fr 2fr"}, "email", "telefon", "notizen_schuldner"],
  defaults: {},
  computed: {},
};
